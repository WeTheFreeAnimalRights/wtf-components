...
import { Separator } from '_/components/separator';
import { Sheet, SheetContent } from '_/components/sheet';
...
const SidebarGroup = React.forwardRef(({ className, ...props }, ref) => {
    return (
        <div
            ...
            data-sidebar="group"
            className={cn(
                'relative flex w-full min-w-0 flex-col p-4 [[data-state=collapsed]_&]:p-2',
                className
            )}
            {...props}
        />
...
const sidebarMenuButtonVariants = cva(
    'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-hover-accent hover:text-sidebar-hover-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-hover-accent data-[state=open]:hover:text-sidebar-hover-accent-foreground group-data-[collapsible=icon]:!size-12 group-data-[collapsible=icon]:!p-3 [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0 data-[state=open]:',
    {
        variants: {
            variant: {
                default:
    ...
    (
        ...
        return (
            <Tooltip>
                ...
                <TooltipContent
                    side={
                        tooltipVisible && (state !== 'collapsed' || isMobile)
                            ? 'bottom'
                            : 'right'
                    }
                    align="center"
