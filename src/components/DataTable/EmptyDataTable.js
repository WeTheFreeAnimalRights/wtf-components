...
import { Cat, Dog, Bird, Fish, Rabbit, Rat, Squirrel, Turtle} from "lucide-react"
...
export const EmptyDataTable = () => {
    ...
    return (
        ...
        <div className="text-center px-8 py-12">
            ...
            <p className="text-gray-500 mt-2">{t('We couldn\'t find any data')}</p>
            <p className="text-gray-500">{t('Refine your search and/or filters')}</p>
        </div>
        </TableCaption>
    )
}
